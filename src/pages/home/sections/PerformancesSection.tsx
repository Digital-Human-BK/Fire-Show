...
const services: ServiceCard[] = [
  {
    ...
    description:
      "A solo high-intensity fire act featuring liquid fuel projection and precision timing for intimate or large-scale events.",
    price: "800 €",
    priceSubtitle: "from*",
    image:
  ...
  },
  {
    title: "Duo Inferno",
    description:
      "Mesmerizing poi and staff patterns performed by two artists, synchronized to cinematic audio tracks.",
    price: "1,500 €",
    priceSubtitle: "from*",
    image:
  ...
  },
  {
    title: "Grand Finale",
    description:
      "Full-scale stage pyrotechnics for festivals, concerts, and corporate galas.",
    price: "3,200 €",
    priceSubtitle: "from*",
    image:
