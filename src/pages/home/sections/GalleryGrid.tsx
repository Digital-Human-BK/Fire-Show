      ...
      <div className={classes.container}>
        <div className={classes.grid}>
          <div className={classes.headerArea}>
            <span className={classes.eyebrow}>The Archive</span>
            <h2 className={classes.heading}>Visual Echoes of Heat</h2>
          </div>
          {galleryImages.map((img) => (
            <div
              key={img.id}
              className={`${classes.imageWrapper} ${img.className}`}
            >
